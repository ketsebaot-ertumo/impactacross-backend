...
module.exports = async () => {
  const sections = await Section.bulkCreate([
    ...
    { key: "value", title: "Vission", description: 'To be a leading African thought partner and catalyst for sustainable development, empowering communities and institutions through transformative research, strategic advice, and inclusive innovation.', isActive: true },
    { key: "value", title: "Core Values", description: 'We commit to integrity, transparency, and respect, valuing diverse perspectives and community leadership. Guided by evidence and collaboration, we deliver high-quality, impactful solutions. Through innovation and adaptability, we stay responsive to evolving challenges.', isActive: true },
