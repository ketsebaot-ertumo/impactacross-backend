...
module.exports = async () => {
  const sections = await Section.bulkCreate([
    ...
    { key: "expertise", title: "Our Sector Expertise", description: "At ImpactAcross, we bring deep, multidisciplinary expertise to address complex development challenges across a range of critical sectors", isActive: true },
