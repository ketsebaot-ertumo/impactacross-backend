...
module.exports = async () => {
    try {
        console.log("Syncing gallary table..");
        await Gallery.sync({ force: true });

        console.log("Seeding gallary with data..");
        await Gallery.bulkCreate([
            ...
            },
            {
                ...
                media_url: 'https://res.cloudinary.com/dq6mvqivd/image/upload/v1761209273/ImpactAcross/images/pbp2hcfnekmjknwtoqap.jpg',
                media_type: 'image',
                category: 'Events',
                createdAt: new Date('2025-06-15T10:00:00Z'),
                updatedAt: new Date('2025-06-15T10:00:00Z')
            },
            {
                ...
                media_url: 'https://res.cloudinary.com/dq6mvqivd/image/upload/v1761209172/ImpactAcross/images/psdz0xfde6yz5mff1pkx.jpg',
                media_type: 'image',
                category: 'Meetings',
                createdAt: new Date('2025-06-15T10:00:00Z'),
                updatedAt: new Date('2025-06-15T10:00:00Z')
