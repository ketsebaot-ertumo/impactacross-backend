...
module.exports = async (sectionMap) => {
  ...
  await WhatWeDoImage.bulkCreate([
    { section_id : sectionMap["what_we_do"], title: "Cross-Sectoral Impact", description: "We conduct technical studies and feasibility assessments that inform transformative solutions across climate change, natural resource management, forestry, livelihoods, energy, and agriculture.", image_url },
    ...
    { section_id : sectionMap["what_we_do"], title: "Geographical Reach", description: "Our consultancy services span multiple regions and countries, with localized strategies that are responsive, scalable, and sustainable.", image_url },
    { section_id : sectionMap["what_we_do"], title: "Holistic Solutions", description: "We integrate policy analysis, technological insights, and practical implementation to develop strategies that bridge research with real-world action.", image_url },
